...
let favFoods = ['tacos', 'burgers', 'pho', 'sandwiches'];
...
favFoods.push ('pizza');
console.log('Added pizza to favorite foods' , favFoods);
...
console.log(' The last food item in array is removed is' , removedFood);
...
favFoods.shift()
console.log('fries removed from front of array', favFoods);
